---
title: "`{arknpi}`: NPPES Npi Registry Archive"
format:
  html:
...
other$I <- vctrs::vec_slice(
  other$I, 
  cheapr::row_na_counts(other$I) < 6)

other$O |> collapse::frename(onm_type = onm_org_type)

other$I |> 
  collapse::frename(
    onm_type = onm_last_type) |> 
  collapse::fcount(onm_prefix)
```
