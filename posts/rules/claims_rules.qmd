...
dplyr::tibble(
  ...
  description = c(
    ...
    "<b>@order</b> in which steps are validated. Certain steps must be ahead of others, for instance:<br><br>
    ...
    "Valid <b>@variable</b> value, it's expected state", 
    
    "Type of <b>@operation</b> defined for validation:<br><br>
    <b>Regex</b>: <b>grepl('^I10', icd) | grepl('^J[0-9]{5}', hcpcs)</b><br><br>
    <b>Calculation</b>: <b>as.integer(dos - dob)</b><br><br>
    <b>Comparison</b>: <b>x > y, x < y, x >= y, x <= y</b><br><br>
    <b>Equality</b>: <b>x == y, identical(x, y)</b><br><br>
    <b>Presence</b>: <b>!is.na(x)</b><br><br>", 
...
rule <- S7::new_class(
  ...
  properties = list(
    ...
    steps = S7::new_property(class = step)
    )
  )
