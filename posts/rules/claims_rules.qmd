...
## Similar Work
   ...
   - [dataverifyr](https://github.com/DavZim/dataverifyr)
   - [cohortBuilder](https://github.com/r-world-devs/cohortBuilder)
...
# Anatomy of a **Variable**
   ...
   - **`procedure`**
     - `hcpcs`: HCPCS Code: `^[A-CEGHJ-MP-V0-9][0-9]{3}[AFMTU0-9]$`
