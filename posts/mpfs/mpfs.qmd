...
rvu24a |>
  ...
  cols_label(pre_op = "Percentage",
             n = "# of HCPCS") |> 
  fmt_percent(columns = pre_op, drop_trailing_zeros = TRUE) |> 
...
rvu24a |>
  ...
  cols_label(intra_op = "Percentage",
             n = "# of HCPCS") |> 
  fmt_percent(columns = intra_op, drop_trailing_zeros = TRUE) |> 
  fmt_integer(columns = n) |> 
  tab_header(
...
rvu24a |>
  ...
  cols_label(post_op = "Percentage",
             n = "# of HCPCS") |> 
  fmt_percent(columns = post_op, drop_trailing_zeros = TRUE) |> 
  fmt_integer(columns = n) |> 
  tab_header(
