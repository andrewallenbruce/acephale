...
meta_ndf <- \(fname) {
  ...
  z <- y[["schema"]][[x[["distribution"]][["identifier"]]]][["fields"]]
  ...
  list(
    ...
    dictionary   = paste0("https://data.cms.gov/provider-data/sites/default/",
                          "files/data_dictionaries/physician/DOC_Data_Dictionary.pdf"),
    dim = c(nrows = y[["count"]], 
            ncols = z[["record_number"]][["length"]]),
    output = data.frame(
      field = names(y[["results"]]), 
      value = dplyr::na_if(delist(y[["results"]]), "")
      ),
    fields = c(
      z[["npi"]][["description"]],
      z[["ind_pac_id"]][["description"]],
      z[["provider_last_name"]][["description"]],
      z[["provider_first_name"]][["description"]],
      z[["provider_middle_name"]][["description"]],
      z[["suff"]][["description"]],
      z[["facility_type"]][["description"]],
      z[["facility_affiliations_certification_number"]][["description"]],
      z[["facility_type_certification_number"]][["description"]]
    ))
}
