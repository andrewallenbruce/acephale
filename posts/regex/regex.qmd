...
long_test <- stringfish::convert_to_sf(c(
  "0214T", 
  "0215T",
  "0217T", 
  "0218T", 
...
First, this function removes the wildcard character (`*`) and any whitespace. Then, it splits the character vector into a list of vectors based on the number of characters in each element. 
...
orphan_regex <- process_orphans(sep)
