...
::: {#nte-packages .callout-tip collapse="true"}
...
HCPCS Level I (CPT)
5 characters long
Begins with any 4 digits, [0-9]{4}
Ends with one of [AFMTU0-9]

HCPCS Level II
5 characters long
Begins with one of [A-CEGHJ-MP-V]
...
::: {#preprocessing .callout-note appearance="simple"}
...
group_hcpcs_2 <- function(x) {
  ...
  indices <- dplyr::tibble(
    code     = stringr::str_sort(x[[2]], numeric = TRUE),
