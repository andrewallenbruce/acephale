...
[![R-CMD-check](https://github.com/andrewallenbruce/{pkgname}/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/andrewallenbruce/{pkgname}/actions/workflows/R-CMD-check.yaml)
...
In the DESCRIPTION file, make sure these two fields are filled out as follows:
